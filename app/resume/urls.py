...
urlpatterns = [
    ...
    path('resumes/<uuid:resume_id>/init-proctor-session/', views.init_proctor_session, name='init-proctor-session'),
    path('proctor/sessions/', views.ProctorSessionListView.as_view(), name='proctor-session-list'),
    path('proctor/sessions/<uuid:session_id>/flag/', views.FlagProctorSessionView.as_view(), name='proctor-flag'),
    path('proctor/sessions/<uuid:session_id>/terminate/', views.TerminateProctorSessionView.as_view(), name='proctor-terminate'),
    path('proctor/sessions/<uuid:session_id>/complete/', views.CompleteProctorSessionView.as_view(), name='proctor-complete'),
