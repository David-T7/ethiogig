...
class AppointmentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'freelancer', 'category', 'skills_passed', 'done','appointment_date']
        read_only_fields = ['id' ,'skills_passed']  # ID is read-only as it is autogenerated

class FreelancerInterviewSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.FreelancerInterview
        fields = ['id', 'interviewer', 'freelancer', 'appointment', 'passed', 'feedback']
        read_only_fields = ['id','passed']  # ID is read-only as it is autogenerated
